...
public sealed partial class TODetourHandler : IContentLoader
{
    ...
    public sealed class DetourSet : IEnumerable<Hook>
    {
        ...
        /// 向集合中添加一个钩子。
        /// </summary>
        /// <param name="hook">要添加的 <see cref="Hook"/> 实例，不能为 <see langword="null"/>。</param>
        /// <exception cref="ArgumentNullException"><paramref name="hook"/> 为 <see langword="null"/>。</exception>
        ...
        /// 移除所有匹配条件的钩子并执行撤销。
        /// </summary>
        /// <param name="match">用于筛选钩子的条件委托，不能为 <see langword="null"/>。</param>
        ...
        /// 否则为 <see langword="null"/>。此参数以未经初始化的形式传递。
        /// </param>
        /// <returns>如果找到至少一个钩子，则返回 <see langword="true"/>；否则返回 <see langword="false"/>。</returns>
        /// <exception cref="ArgumentNullException"><paramref name="targetMethod"/> 为 <see langword="null"/>。</exception>
    ...
    /// <param name="sourceName">当解析成功时，输出源方法名称；否则为 <see langword="null"/>。</param>
    ...
    /// </summary>
    /// <param name="detour">Detour 方法，必须是具名方法。</param>
    /// <param name="sourceTypeName">当解析成功时，输出源类型名称；否则为 <see langword="null"/>。</param>
    /// <param name="sourceMethodName">当解析成功时，输出源方法名称；否则为 <see langword="null"/>。</param>
    /// <returns>解析是否成功。</returns>
    /// <remarks>
    /// <para>解析逻辑：</para>
    /// <list type="number">
    ...
    /// <exception cref="ArgumentNullException"><paramref name="source"/> 或 <paramref name="detour"/> 为 <see langword="null"/>。</exception>
    /// <remarks>
    ...
    /// <returns>如果成功应用则返回创建的 <see cref="Hook"/> 对象；否则返回 <see langword="null"/>。</returns>
    /// <remarks>
...
public sealed partial class TOILEditingHandler : IContentLoader
{
    ...
    /// <exception cref="ArgumentNullException"><paramref name="source"/> 或 <paramref name="manip"/> 为 <see langword="null"/>。</exception>
    ...
    /// <exception cref="ArgumentNullException"><paramref name="source"/> 或 <paramref name="manipMethod"/> 为 <see langword="null"/>。</exception>
