...
public sealed partial class EmpressofLight_Anomaly : AnomalyNPCBehavior
{
    public static class EmpressOfLightLegacyCalamityAI
    {
        ...
        public static bool AI(NPC npc, CalamityGlobalNPC calamityGlobalNPC)
        {
            // Difficulty bools.
            ...
            calamityGlobalNPC.CurrentlyEnraged = !bossRush && dayTimeEnrage;
            ...
            switch ((int)npc.ai[0])
            {
                ...
                case 2:
                    ...
                    if (npc.ai[1] < 60f)
                        AI_120_HallowBoss_DoMagicEffect(npc, npc.Center + randomStreakOffset, 1, Utils.GetLerpValue(0f, 60f, npc.ai[1], clamped: true));

                    int streakSpawnFrequency = CalamityWorld_Bridge.LegendaryMode ? 1 : 2;
                    if (phase3)
                    ...
                    if ((int)npc.ai[1] % streakSpawnFrequency == 0 && npc.ai[1] < 60f)
                    {
                        ...
                        if (Main.netMode != NetmodeID.MultiplayerClient)
                        {
                            ...
                            if (phase3)
                            {
                                ...
                                if (Main.rand.NextBool(60) && CalamityWorld_Bridge.LegendaryMode)
                                {
                ...
                case 4:
                    ...
                    {
                        AI_120_HallowBoss_DoMagicEffect(npc, npc.Center + new Vector2(-55f, -20f), 2, Utils.GetLerpValue(0f, lanceGateValue, npc.ai[1], clamped: true));
                        AI_120_HallowBoss_DoMagicEffect(npc, npc.Center + new Vector2(55f, -20f), 4, Utils.GetLerpValue(0f, lanceGateValue, npc.ai[1], clamped: true));
                    }
                ...
                case 5:
                    ...
                    if (npc.ai[1] < 42f)
                        AI_120_HallowBoss_DoMagicEffect(npc, npc.Center + magicSpawnOffset, 3, Utils.GetLerpValue(0f, 42f, npc.ai[1], clamped: true));
                    ...
                    if (npc.ai[1] % 42f == 0f && npc.ai[1] < 42f)
                    {
                        ...
                        float totalProjectiles = CalamityWorld_Bridge.LegendaryMode ? 30f : death ? (dayTimeEnrage ? 22f : 15f) : (dayTimeEnrage ? 18f : 13f);
                        int projIndex = 0;
                        ...
                        for (float i = 0f; i < 1f; i += 1f / totalProjectiles)
                        {
                            ...
                            if (dayTimeEnrage && projIndex % 2 == 0)
                                initialVelocity *= 2f;
                            if (CalamityWorld_Bridge.LegendaryMode)
                ...
                case 9:
                    ...
                    AI_120_HallowBoss_DoMagicEffect(npc, npc.Center, 5, Utils.GetLerpValue(40f, 90f, npc.ai[1], clamped: true));
                    ...
                    else if (npc.ai[1] <= chargeGateValue + chargeDuration)
                    {
                        ...
                        if ((npc.ai[1] - 1f) % rainbowStreakGateValue == 0f)
                        {
                            ...
                            if (Main.netMode != NetmodeID.MultiplayerClient)
                            {
                                ...
                                if (Main.rand.NextBool(30) && CalamityWorld_Bridge.LegendaryMode)
                                {
                                    Main.projectile[proj].extraUpdates += 1;
                                    Main.projectile[proj].netUpdate = true;
                                }
                ...
                case 11:
                    ...
                    if (npc.ai[1] >= 6f && npc.ai[1] < 54f)
                    {
                        AI_120_HallowBoss_DoMagicEffect(npc, npc.Center + new Vector2(-55f, -20f), 2, Utils.GetLerpValue(0f, lanceGateValue2, npc.ai[1], clamped: true));
                        AI_120_HallowBoss_DoMagicEffect(npc, npc.Center + new Vector2(55f, -20f), 4, Utils.GetLerpValue(0f, lanceGateValue2, npc.ai[1], clamped: true));
                    }
                ...
                case 12:
                    ...
                    if (shouldSpawnStreaks)
                        AI_120_HallowBoss_DoMagicEffect(npc, npc.Center + projRandomOffset, 1, Utils.GetLerpValue(0f, 60f, npc.ai[1], clamped: true));
                    ...
                    if ((int)npc.ai[1] % stationaryStreakSpawnFrequency == 0 && shouldSpawnStreaks)
                    {
                        ...
                        if (Main.netMode != NetmodeID.MultiplayerClient)
                        {
                            ...
                            if (phase3)
                            {
                                ...
                                if (Main.rand.NextBool(15) && CalamityWorld_Bridge.LegendaryMode)
                                {
                                    Main.projectile[proj2].extraUpdates += 1;
                                    Main.projectile[proj2].netUpdate = true;
                                }
        ...
        private static void CreateSpawnDust(NPC npc, bool useAI = true)
        {
            ...
            float timer = useAI ? npc.ai[1] : npc.CalamityNPC.newAI[0];
            float spawnTime = 180f;
        ...
        private static void AI_120_HallowBoss_DoMagicEffect(NPC npc, Vector2 spot, int effectType, float progress)
        {
